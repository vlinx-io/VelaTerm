...
const de: typeof en = {
  ...
  "chat.followModelDefaultHintNamed": (model: string) => `Verwendet das in der Agentenkonfiguration festgelegte Modell (derzeit ${model}).`,
  ...
  "chat.catalogCli": "Installierte Claude-CLI",
