...
const zhCN: typeof en = {
  ...
  "settings.codexHooksDesc": "查看和控制 Codex 用户、项目、插件和托管配置中的 Hooks。",
  "settings.codexHooksEnabledCount": (enabled: number, total: number) =>
    `已启用 ${enabled} / ${total}`,
  "settings.codexHooksEmpty": "未找到 Codex Hook。",
  "settings.codexHooksTrust": "信任",
  "settings.codexHooksUser": "用户配置",
  "settings.codexHooksProject": "项目配置",
  "settings.codexHooksPlugin": "插件",
  "settings.codexHooksSession": "会话",
  "settings.codexHooksManagedSource": "托管配置",
  "settings.codexHooksManaged": "已托管",
  "settings.codexHooksTrusted": "已信任",
  "settings.codexHooksChanged": "已更改",
  "settings.codexHooksReview": "需要审核",
  "settings.codexHooksDisabled": "已禁用",
  "settings.codexHooksHandler": "处理器",
  "settings.codexHooksCommand": "命令",
  "settings.codexHooksMatcher": "匹配器",
  "settings.codexHooksTimeout": "超时",
  "settings.codexHooksStatusMessage": "状态消息",
  "settings.codexHooksAll": "全部",
  "settings.codexHooksNone": "无",
