...
const vi: typeof en = {
  ...
  "settings.codexHooks": "Hook Codex",
  "settings.codexHooksDesc":
    "Xem xét và kiểm soát hook từ cấu hình người dùng, dự án, plugin và cấu hình được quản lý của Codex.",
  "settings.codexHooksEnabledCount": (enabled: number, total: number) =>
    `Đã bật ${enabled} / ${total}`,
  "settings.codexHooksEmpty": "Không tìm thấy hook Codex.",
  "settings.codexHooksTrust": "Tin cậy",
  "settings.codexHooksUser": "Cấu hình người dùng",
  "settings.codexHooksProject": "Cấu hình dự án",
  "settings.codexHooksPlugin": "Plugin",
  "settings.codexHooksSession": "Phiên",
  "settings.codexHooksManagedSource": "Cấu hình được quản lý",
  "settings.codexHooksManaged": "Được quản lý",
  "settings.codexHooksTrusted": "Đã tin cậy",
  "settings.codexHooksChanged": "Đã thay đổi",
  "settings.codexHooksReview": "Cần xem xét",
  "settings.codexHooksDisabled": "Đã tắt",
  "settings.codexHooksHandler": "Trình xử lý",
  "settings.codexHooksCommand": "Lệnh",
  "settings.codexHooksMatcher": "Bộ khớp",
  "settings.codexHooksTimeout": "Thời gian chờ",
  "settings.codexHooksStatusMessage": "Thông báo trạng thái",
  "settings.codexHooksAll": "Tất cả",
  "settings.codexHooksNone": "Không có",
