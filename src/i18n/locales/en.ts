...
const en = {
  ...
  "settings.codexHooksDesc":
    "Review and control hooks discovered from your Codex user, project, plugin, and managed configuration.",
  "settings.codexHooksEnabledCount": (enabled: number, total: number) =>
    `Enabled ${enabled} / ${total}`,
  "settings.codexHooksEmpty": "No Codex hooks were found.",
  "settings.codexHooksTrust": "Trust",
  "settings.codexHooksUser": "User config",
  "settings.codexHooksProject": "Project config",
  "settings.codexHooksPlugin": "Plugin",
  "settings.codexHooksSession": "Session",
  "settings.codexHooksManagedSource": "Managed config",
  "settings.codexHooksManaged": "Managed",
  "settings.codexHooksTrusted": "Trusted",
  "settings.codexHooksChanged": "Changed",
  "settings.codexHooksReview": "Review required",
  "settings.codexHooksDisabled": "Disabled",
  "settings.codexHooksHandler": "Handler",
  "settings.codexHooksCommand": "Command",
  "settings.codexHooksMatcher": "Matcher",
  "settings.codexHooksTimeout": "Timeout",
  "settings.codexHooksStatusMessage": "Status message",
  "settings.codexHooksAll": "All",
  "settings.codexHooksNone": "None",
