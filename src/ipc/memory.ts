...
export interface MemoryJob {
  id: string; sourceId: string; sessionName: string; agent: string; model: string; status: string; stage: string;
...
export const memoryStart = (sessionId: string, agent: string, model: string) => invoke<{ id: string; reused: boolean }>("memory_start", { sessionId, agent, model });
